...
public class ParametersManagementConstant {
	...
	//CurrencyDetails 
	public static final int currencytNameLength = 32;
	public static final int currencyDescriptionLength = 256;
	public static final int currencyCodeLength = 3;
	public static final int baseRateCurrencyLength = 3;
	public static final int baseRateLength = 6;
	
	public static final String successMessageForCurrencyDetailsDeleteMethod = "Successfully deleted currency details.";
